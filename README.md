...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This engineering documentation provides an in-depth overview of the BSU Spartan Team's self-driving robot, designed and programmed by our team from the Philippines for the Future Engineers Category at the WRO Turkiye 2024 International Finals. Here, you’ll find details about the robot’s design, functionality, and features, reflecting our dedication to pushing the boundaries of autonomous technology.

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This gives key aspects of the BSU Spartan Team’s robot’s development. It covers  Mobility Management, detailing motor selection, chassis design, and assembly based on principles of speed, torque, and power; Power and Sense Management, explaining the vehicle’s power sources and sensor configurations, supported by a wiring diagram and Bill of Materials (BOM); Obstacle Management, outlining strategies for navigating the course with flow diagrams and detailed code. To further support these technical details, the team added visual documentation that includes actual and 3D model images of the robot from all sides and team photos. Moreover, performance videos showcase the robot’s functionality across challenges. All of this reflects our team’s dedication to pushing the boundaries of autonomous technology and achieving excellence on the global stage.
...
<p align = "center"><img src = "https://github.com/AbeBuck/BSU-Spartan-Team_FE-2024/blob/main/Discussion%20Images/0.0.png" width = "800"></p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The camera is programmed to use LAB thresholds to identify the color of the traffic signs, which should be either green or red. A proper given threshold can be obtained in different ways, but trial and error should be enough and being familiarized with the LAB color space could help. Here are the LAB thresholds of the team for the obstacles:
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The main program for traffic sign detection is provided here: [`FE_ObstacleRecognition.py`](https://github.com/AbeBuck/BSU-Spartan-Team_FE-2024/blob/main/Source%20Code/Obstacle%20Challenge%20Source%20Code/Camera%20Source%20Code/FE_ObstacleRecognition.py). This program is uploaded to the OpenMV Cam H7 Plus. For the step by step guide how the program is compiled and uploaded to the camera, refer to [<i>Camera Program Guide</i>](#camera-program-guide) in [<i>Chapter 6: Construction Guide</i>](#6-construction-guide)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Similar to the traffic signs, the robot is set to record the position of the parking lot on the field during its first lap. Having a reference of the position of the parking lot, the robot is programmed to follow a specific route: the robot will glide itself to the outer wall until it reaches the corner section before the straightforward section where the parking lot is positioned. The robot will then follow the route for the Green traffic sign with the presence of a parking lot, which is showcased in Figure 3.4 earlier. Afterwards, the robot will perform a perpendicular parking between the parking lot boundaries, marking the end of the run for the Obstacle Challenge Round. An illustration is provided for a better visualization.
...
<img src = "https://github.com/AbeBuck/BSU-Spartan-Team_FE-2024/blob/main/Discussion%20Images/4.0.4.png?">
...
<img src = "https://github.com/AbeBuck/BSU-Spartan-Team_FE-2024/blob/main/Wiring%20Diagram/Sub%20Hub%20Wiring%20Diagram.png?">
